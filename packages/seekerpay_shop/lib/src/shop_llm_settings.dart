...
class _ShopLlmSettingsState extends State<ShopLlmSettings> {
  static const _kPrimary = Colors.white, _kSurface = Colors.transparent, _kRed = Color(0xFFFF5252), _kGreen = Color(0xFF00E676);
  bool _enabled = false;
        ...
        Padding(padding: const EdgeInsets.fromLTRB(16, 14, 16, 16), child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          ...
          if (_allOk) ...[
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              GestureDetector(onTap: () => setState(() => _showRules = !_showRules), child: Text(_showRules ? 'HIDE RULES' : 'SHOW RULES', style: TextStyle(color: Colors.white.withValues(alpha:0.4), fontSize: 8, fontWeight: FontWeight.w900, letterSpacing: 1))),
            ]),
            if (_showRules) ...[
...
class _ClaudeVisionSettingsState extends State<ClaudeVisionSettings> {
  static const _kPrimary = Colors.white, _kSurface = Colors.transparent;
